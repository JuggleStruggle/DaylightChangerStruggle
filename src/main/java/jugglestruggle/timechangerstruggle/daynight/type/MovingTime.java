...
public class MovingTime extends MovingTimeBasis
{
	...
	public Set<BaseProperty<?, ?>> createProperties()
	{
		...
		props.add(new FancySectionProperty("updating", new TranslatableText(PROPERTIES_KEY+"updating")));
		props.add(this.getTicksUntilNextCallProp());
		
		props.add(new FancySectionProperty("speed", new TranslatableText(PROPERTIES_KEY+"speed")));
