...
public class StringValue extends BaseProperty<StringValue, String>
{
	...
	{
		if (widget instanceof WidgetPositionedTooltip && owningSection != null && owningSection.get() != null)
		{
			if (owningSection.get() instanceof TranslatableText)
			{
				...
				((WidgetPositionedTooltip)widget).updateTooltip(tooltipDescText, null, screen.getTextRenderer());
			}
		}
	}
